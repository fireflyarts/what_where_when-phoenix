defmodule WhatWhereWhen.People do
  ...
  def change_person_registration(%Person{} = person, attrs \\ %{}) do
    Person.registration_changeset(person, attrs, hash_password: false)
  end
  ...
  def change_person_email(person, attrs \\ %{}) do
    Person.email_changeset(person, attrs)
  end
  ...
  ## Examples
      ...
      iex> deliver_update_email_instructions(person, current_email, &Routes.person_update_email_url(conn, :edit, &1))
      {:ok, %{to: ..., body: ...}}
  ...
  ## Examples
      ...
      iex> deliver_person_confirmation_instructions(person, &Routes.person_confirmation_url(conn, :edit, &1))
      {:ok, %{to: ..., body: ...}}

      iex> deliver_person_confirmation_instructions(confirmed_person, &Routes.person_confirmation_url(conn, :edit, &1))
  ...
  ## Examples
      ...
      iex> deliver_person_reset_password_instructions(person, &Routes.person_reset_password_url(conn, :edit, &1))
      {:ok, %{to: ..., body: ...}}
