defmodule WhatWhereWhenWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use WhatWhereWhenWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import WhatWhereWhenWeb.ConnCase

      alias WhatWhereWhenWeb.Router.Helpers, as: Routes

      # The default endpoint for testing
      @endpoint WhatWhereWhenWeb.Endpoint
    end
  end

  setup tags do
    WhatWhereWhen.DataCase.setup_sandbox(tags)
  ...
  def register_and_log_in_person(%{conn: conn}) do
    person = WhatWhereWhen.PeopleFixtures.person_fixture()
  ...
  def log_in_person(conn, person) do
    token = WhatWhereWhen.People.generate_person_session_token(person)
