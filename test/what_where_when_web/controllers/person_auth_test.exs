defmodule WhatWhereWhenWeb.PersonAuthTest do
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, WhatWhereWhenWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_person/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      WhatWhereWhenWeb.Endpoint.subscribe(live_socket_id)
